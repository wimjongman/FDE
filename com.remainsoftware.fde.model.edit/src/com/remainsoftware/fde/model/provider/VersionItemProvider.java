...
/**
 * This is the item provider adapter for a {@link com.remainsoftware.fde.model.Version} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VersionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.VERSION__VERSION,
				 true,
				 false,
				 false,
	...
	protected void addFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_features_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_features_feature", "_UI_Version_type"),
				 ModelPackage.Literals.VERSION__FEATURES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.VERSION__FEATURES);
			childrenFeatures.add(ModelPackage.Literals.VERSION__BUNDLES);
			childrenFeatures.add(ModelPackage.Literals.VERSION__FRAGMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((Version)object).getVersion();

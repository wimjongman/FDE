 ...
 * <ul>
 * <li>{@link com.remainsoftware.fde.model.impl.VersionImpl#getVersion <em>
 * Version</em>}</li>
 * <li>{@link com.remainsoftware.fde.model.impl.VersionImpl#getFeatures <em>
 * Features</em>}</li>
 * <li>{@link com.remainsoftware.fde.model.impl.VersionImpl#getBundles <em>
 * Bundles</em>}</li>
 * <li>{@link com.remainsoftware.fde.model.impl.VersionImpl#getFragments <em>
 * Fragments</em>}</li>
 * </ul>
 * </p>
 *
...
public class VersionImpl extends MinimalEObjectImpl.Container implements Version {
	...
	public void setVersion(String newVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VERSION__VERSION,
					oldVersion, version));
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this,
					ModelPackage.VERSION__FEATURES);
		}
		return features;
	}
	...
	public EList<Fragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentEList<Fragment>(Fragment.class, this,
					ModelPackage.VERSION__FRAGMENTS);
		}
		return fragments;
	}

	/**
	 * Finds the feature, bundle or fragment with the passed id. Returns null if
	 * no such thing can be found.
	 */
	public Manifest findManifest(String Id) {
		...
		for (Bundle bundle : getBundles()) {
			if (Id.equals(bundle.getId())) {
				return bundle;
			}
		}

		for (Bundle bundle : getFragments()) {
			if (Id.equals(bundle.getId())) {
				return bundle;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case ModelPackage.VERSION___FIND_MANIFEST__STRING:
			return findManifest((String) arguments.get(0));
		}
